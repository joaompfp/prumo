CATALOG = {
  ...
  "EUROSTAT": {
    ...
    "indicators": {
      ...
      "ipi_electronics":          {"label": "IPI Electrónica e Óptica (PT, Eurostat)",     "description": "IPI do sector de equipamentos electrónicos e ópticos (NACE C26), multi-país Eurostat. Fonte: Eurostat, STS_INPR_M.", "unit": "Índice 2021=100", "frequency": "monthly", "since": "1980-01", "until": "2023-12", "rows": 307, "tags": ["produção", "electrónica", "indústria"]},
      "ipi_food_beverage":        {"label": "IPI Alimentação e Bebidas (PT, Eurostat)",     "description": "IPI do sector alimentar e de bebidas (NACE C10-C12), multi-país Eurostat. Série com atraso Eurostat (NACE C10-C12 publica com lag >24m). Fonte: Eurostat, STS_INPR_M.", "unit": "Índice 2021=100", "frequency": "monthly", "lag_months": 24, "since": "1980-01", "until": "2023-12", "rows": 180, "tags": ["produção", "alimentar", "indústria"]},
      "ipi_manufacturing":        {"label": "IPI Ind. Transformadora (Eurostat)",           "description": "IPI da indústria transformadora (NACE C), multi-país Eurostat, série longa desde 2000. Fonte: Eurostat, STS_INPR_M.", "unit": "Índice 2021=100", "frequency": "monthly", "since": "2000-01", "until": "2025-12", "rows": 312, "tags": ["produção", "indústria", "europa"]},
      "ipi_nonmetallic":          {"label": "IPI Minerais Não Metálicos (PT, Eurostat)",    "description": "IPI do sector de minerais não metálicos (NACE C23). Cerâmica, cimento, vidro. Multi-país Eurostat. Fonte: Eurostat, STS_INPR_M.", "unit": "Índice 2021=100", "frequency": "monthly", "since": "1980-01", "until": "2023-12", "rows": 312, "tags": ["produção", "minerais", "indústria"]},
      "ipi_textiles":             {"label": "IPI Têxteis e Vestuário (PT, Eurostat)",       "description": "IPI do sector têxtil, vestuário e calçado (NACE C13-C15), multi-país Eurostat. Fonte: Eurostat, STS_INPR_M.", "unit": "Índice 2021=100", "frequency": "monthly", "since": "1980-01", "until": "2023-12", "rows": 250, "tags": ["produção", "têxteis", "indústria"]},
      "ipi_total":                {"label": "IPI Total Indústria (Eurostat)",                "description": "IPI total da indústria (NACE B+C+D+E), multi-país Eurostat, série longa. Fonte: Eurostat, STS_INPR_M.", "unit": "Índice 2021=100", "frequency": "monthly", "since": "2000-01", "until": "2025-12", "rows": 312, "tags": ["produção", "indústria", "europa"]},
      "ipi_wood_paper":           {"label": "IPI Madeira, Papel e Impressão (PT, Eurostat)","description": "IPI do sector de madeira, papel e actividades de impressão (NACE C16-C18), multi-país Eurostat. Fonte: Eurostat, STS_INPR_M.", "unit": "Índice 2021=100", "frequency": "monthly", "since": "1980-01", "until": "2023-12", "rows": 252, "tags": ["produção", "madeira", "papel"]},
      "labour_productivity_hour":        {"label": "Produtividade por Hora Trabalhada (UE)", "description": "Índice de produtividade do trabalho por hora trabalhada, multi-país UE. Mede a relação entre o output económico e o volume total de horas trabalhadas. Fonte: Eurostat.", "unit": "Índice", "frequency": "annual", "since": "1975-01", "until": "2025-01", "rows": 30, "tags": ["produtividade", "trabalho", "competitividade"]},
      "labour_productivity_hour_real":   {"label": "Produtividade por Hora — Real (UE)",    "description": "Índice real de produtividade do trabalho por hora, deflacionado pelo deflactor do PIB. Multi-país UE. Fonte: Eurostat.", "unit": "Índice", "frequency": "annual", "since": "1975-01", "until": "2025-01", "rows": 30, "tags": ["produtividade", "trabalho"]},
      "labour_productivity_per_hour":    {"label": "Produtividade por Hora (UE — nível)",   "description": "Nível de produtividade do trabalho por hora trabalhada em termos reais. Multi-país UE. Fonte: Eurostat.", "unit": "Índice", "frequency": "annual", "since": "1975-01", "until": "2025-01", "rows": 30, "tags": ["produtividade", "trabalho"]},
      "labour_productivity_person_real": {"label": "Produtividade por Trabalhador — Real (UE)", "description": "Índice real de produtividade do trabalho por pessoa empregada. Multi-país UE. Fonte: Eurostat.", "unit": "Índice", "frequency": "annual", "since": "1975-01", "until": "2025-01", "rows": 30, "tags": ["produtividade", "trabalho"]},
      "unit_labour_cost":        {"label": "Custo Unitário do Trabalho (UE)",             "description": "Índice de custos unitários nominais do trabalho (remunerações / produtividade), multi-país UE. Indicador-chave de competitividade-custo. Fonte: Eurostat.", "unit": "Índice", "frequency": "annual", "since": "1975-01", "until": "2025-01", "rows": 30, "tags": ["custos", "trabalho", "competitividade"]},
      "unit_labour_cost_hour":   {"label": "Custo Unitário por Hora (UE)",                "description": "Custo unitário do trabalho calculado com base em horas trabalhadas. Multi-país UE. Fonte: Eurostat.", "unit": "Índice", "frequency": "annual", "since": "1975-01", "until": "2025-01", "rows": 30, "tags": ["custos", "trabalho"]},
      "unit_labour_cost_person": {"label": "Custo Unitário por Trabalhador (UE)",         "description": "Custo unitário do trabalho calculado com base em número de pessoas empregadas. Multi-país UE. Fonte: Eurostat.", "unit": "Índice", "frequency": "annual", "since": "1975-01", "until": "2025-01", "rows": 30, "tags": ["custos", "trabalho"]},
      "gdp_quarterly":            {"label": "PIB Trimestral (Eurostat)",                   "description": "Produto Interno Bruto trimestral, multi-país UE, em índice ou volume. Fonte: Eurostat, NAMQ_10_GDP.", "unit": "Índice", "frequency": "quarterly", "since": "2000-01", "until": "2025-12", "rows": 103, "tags": ["pib", "macro", "europa"]},
      "gdp_per_capita_eur":       {"label": "PIB per capita — EUR correntes (Eurostat)",   "description": "PIB per capita em euros correntes, multi-país UE. Permite comparação nominal entre países da zona euro. Fonte: Eurostat, NAMA_10_PC.", "unit": "€/hab.", "frequency": "annual", "since": "1975-01", "until": "2025-01", "rows": 30, "tags": ["pib", "macro", "europa"]},
      "gdp_per_capita_pps":       {"label": "PIB per capita — PPC (Eurostat)",             "description": "PIB per capita em Paridade de Poder de Compra (PPS), multi-país UE. Elimina diferenças de nível de preços para comparação real. Fonte: Eurostat.", "unit": "PPS", "frequency": "annual", "since": "2000-01", "until": "2024-01", "rows": 25, "tags": ["pib", "macro", "comparação"]},
      "gov_debt_pct_gdp":         {"label": "Dívida Pública (% PIB, Eurostat)",            "description": "Dívida bruta das administrações públicas em % do PIB, multi-país UE. Critério de Maastricht: ≤60%. Fonte: Eurostat, GOV_10DD_GGDEBT.", "unit": "% PIB", "frequency": "annual", "since": "1995-01", "until": "2024-01", "rows": 30, "tags": ["dívida", "finanças públicas", "europa"]},
      "gov_deficit_pct_gdp":      {"label": "Défice Público (% PIB, Eurostat)",            "description": "Saldo das administrações públicas em % do PIB, multi-país UE. Critério de Maastricht: ≤−3%. Fonte: Eurostat, GOV_10DD_GGDEBT.", "unit": "% PIB", "frequency": "annual", "since": "1995-01", "until": "2024-01", "rows": 30, "tags": ["défice", "finanças públicas", "europa"]},
      "employment_rate":          {"label": "Taxa de Emprego (Eurostat)",                  "description": "Taxa de emprego da população em idade activa (15-64 anos), multi-país UE. Fonte: Eurostat, LFSI_EMP_A.", "unit": "%", "frequency": "annual", "since": "2003-01", "until": "2024-01", "rows": 16, "tags": ["emprego", "trabalho", "europa"]},
      "current_account_pct_gdp":  {"label": "Balança Corrente (% PIB)",                   "description": "Saldo da balança corrente (bens, serviços, rendimentos e transferências correntes) como % do PIB. Fonte: Eurostat.", "unit": "% PIB", "frequency": "quarterly", "since": "2020-01", "until": "2025-12", "rows": 23, "tags": ["balança corrente", "macro"]},
      "hicp":                     {"label": "IHPC — Índice (Eurostat, multi-país)",        "description": "Índice Harmonizado de Preços no Consumidor (IHPC) em nível (base 2015=100), multi-país UE. Fonte: Eurostat, PRC_HICP_MIDX.", "unit": "Índice 2015=100", "frequency": "monthly", "since": "2000-01", "until": "2025-12", "rows": 312, "tags": ["inflação", "preços", "europa"]},
      "unemployment_m": {"label": "Desemprego Mensal (mil pessoas)", "description": "Número de pessoas desempregadas nos países UE, em milhares de pessoas. Séries mensais Eurostat. Fonte: Eurostat, UNE_RT_M.", "unit": "mil pessoas", "frequency": "monthly", "since": "2000-01", "until": "2025-12", "rows": 312, "tags": ["desemprego", "emprego", "macro"]},
      "cci":                      {"label": "Confiança Consumidor (Eurostat, multi-país)", "description": "Indicador composto de confiança do consumidor, multi-país UE/ZE. Inquérito harmonizado mensal. Fonte: Eurostat / Comissão Europeia, BCS.", "unit": "Saldo", "frequency": "monthly", "since": "1985-01", "until": "2026-02", "rows": 477, "tags": ["confiança", "consumo", "europa"]},
      "consumer_confidence":      {"label": "Confiança Consumidores UE",                  "description": "Indicador de confiança dos consumidores UE, saldo de respostas ao inquérito harmonizado da Comissão Europeia. Fonte: Eurostat, BCS.", "unit": "Saldo", "frequency": "monthly", "since": "1985-01", "until": "2026-02", "rows": 477, "tags": ["confiança", "consumo"]},
      "hourly_labour_cost_index": {"label": "Índice Custo Horário do Trabalho (UE)",      "description": "Índice do custo total horário do trabalho (salários + encargos patronais), multi-país UE. Fonte: Eurostat, LCI.", "unit": "Índice", "frequency": "annual", "since": "2000-01", "until": "2024-01", "rows": 25, "tags": ["custos", "trabalho", "competitividade"]},
      ...
      "construction_output":      {"label": "Produção na Construção (UE)",                "description": "Volume de produção no sector da construção em euros reais, multi-país UE. Fonte: Eurostat.", "unit": "Índice", "frequency": "monthly", "since": "1990-01", "until": "2023-12", "rows": 312, "tags": ["construção", "produção"]},
      "STS_INPR_M_BD": {
      ...
      "earn_ses_pub2s": {
        "label": "Salários Horários Médios — Sector Público (EUR)",
        "description": "Salário horário bruto médio no sector público por país, dados do inquérito SES. Quadrienal.",
        "unit": "EUR/hora",
        "frequency": "annual",
        "lag_months": 36,
        "since": "2006-01",
        "until": "2022-01",
        "rows": 5,
        "tags": ["salários", "sector público", "europa"],
        "discontinued": True,
      },
      "electricity_price_household": {
        "label": "Preço Electricidade Doméstico (EUR/kWh)",
        "description": "Preço médio da electricidade para consumidores domésticos por país (Band DC). Semestral.",
        "unit": "EUR/kWh",
        "frequency": "semester",
        "lag_months": 6,
        "since": "2008-01",
        "until": "2025-01",
        "rows": 35,
        "tags": ["energia", "electricidade", "preço", "europa"],
      },
      "price_level_index": {
        "label": "Índice de Nível de Preços (UE27=100)",
        "description": "Índice de nível de preços relativo face à média UE27. Anual.",
        "unit": "Index (EU27=100)",
        "frequency": "annual",
        "lag_months": 18,
        "since": "1995-01",
        "until": "2020-01",
        "rows": 26,
        "tags": ["preços", "custo de vida", "europa"],
        "discontinued": True,
      },
}
  },
  ...
  "WORLDBANK": {
    ...
    "indicators": {
      ...
      "life_expectancy":             {"label": "Esperança de Vida",                               "description": "Esperança de vida à nascença em Portugal (anos). Inclui ambos os sexos. Fonte: Banco Mundial, SP.DYN.LE00.IN.", "unit": "anos", "frequency": "annual", "lag_months": 24, "since": "1960-01", "until": "2023-01", "rows": 64, "tags": ["demografia", "saúde"]},
      "death_rate":                  {"label": "Taxa de Mortalidade",                             "description": "Taxa bruta de mortalidade em Portugal (óbitos por 1.000 habitantes). Fonte: Banco Mundial, SP.DYN.CDRT.IN.", "unit": "por 1.000 hab.", "frequency": "annual", "lag_months": 24, "since": "1960-01", "until": "2023-01", "rows": 64, "tags": ["demografia", "saúde"]},
      ...
      "gini":                        {"label": "Índice de Gini (Desigualdade)",                    "description": "Coeficiente de Gini de desigualdade de rendimentos para Portugal (0=igualdade total, 100=desigualdade total). Fonte: Banco Mundial, SI.POV.GINI.", "unit": "Índice (0-100)", "frequency": "annual", "lag_months": 24, "since": "2003-01", "until": "2023-01", "rows": 21, "tags": ["desigualdade", "social"]},
      "gov_debt_pct_gdp_wb":         {"label": "Dívida Pública (% PIB, Banco Mundial)",           "description": "Dívida bruta do governo central como % do PIB, Portugal. Fonte: Banco Mundial / FMI.", "unit": "% PIB", "frequency": "annual", "lag_months": 24, "since": "1993-01", "until": "1994-01", "rows": 2, "tags": ["dívida", "finanças públicas"], "discontinued": True},
      ...
      "school_enrollment_secondary": {"label": "Escolarização Secundária (%)",                    "description": "Taxa bruta de escolarização no ensino secundário em Portugal (% do grupo etário relevante). Fonte: Banco Mundial / UNESCO.", "unit": "%", "frequency": "annual", "lag_months": 24, "since": "2000-01", "until": "2023-01", "rows": 24, "tags": ["educação", "social"]},
      "tertiary_enrollment":         {"label": "Frequência do Ensino Superior (%)",               "description": "Taxa bruta de frequência do ensino superior em Portugal (% do grupo etário 18-22 anos). Fonte: Banco Mundial / UNESCO.", "unit": "%", "frequency": "annual", "lag_months": 24, "since": "2015-01", "until": "2023-01", "rows": 9, "tags": ["educação", "ensino superior"]},
      "literacy_rate":               {"label": "Taxa de Literacia (%)",                           "description": "Percentagem da população portuguesa com 15+ anos que sabe ler e escrever. Fonte: Banco Mundial / UNESCO.", "unit": "% pop. 15+", "frequency": "annual", "lag_months": 24, "since": "1981-01", "until": "2011-01", "rows": 3, "tags": ["educação", "social"], "discontinued": True},
    },
  },
}
