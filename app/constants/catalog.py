CATALOG = {
  ...
  "EUROSTAT": {
    ...
    "indicators": {
      ...
      "ipi_food_beverage":        {"label": "IPI Alimentação e Bebidas (PT, Eurostat)",     "description": "IPI do sector alimentar e de bebidas (NACE C10-C12), multi-país Eurostat. Fonte: Eurostat, STS_INPR_M.", "unit": "Índice 2021=100", "frequency": "monthly", "since": "1980-01", "until": "2023-12", "rows": 180, "tags": ["produção", "alimentar", "indústria"]},
