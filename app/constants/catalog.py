CATALOG = {
  ...
  "FRED": {
    ...
    "indicators": {
      ...
      "cotton": {
        "label": "Algodão (USD/libra) [alt]",
        "description": "Preço mensal do algodão (A Index), USD/libra. Série alternativa à commodity_cotton. Fonte: FRED, PCOTTINDUSDM.",
        "unit": "USD/lb",
        "frequency": "monthly",
        "since": "2003-01",
        "until": "2026-01",
        "rows": 277,
        "tags": ["commodities", "têxteis"],
      },
      "iron_ore": {
        "label": "Minério de Ferro (USD/t) [alt]",
        "description": "Preço mensal do minério de ferro (62% Fe), USD/tonelada. Série alternativa à commodity_iron_ore. Fonte: FRED, PIORECRUSDM.",
        "unit": "USD/t",
        "frequency": "monthly",
        "since": "2015-01",
        "until": "2026-01",
        "rows": 133,
        "tags": ["commodities", "metais"],
      },
      "nickel": {
        "label": "Níquel (USD/tonelada) [alt]",
        "description": "Preço mensal do níquel no LME, USD/tonelada. Série alternativa à commodity_nickel. Fonte: FRED, PNICKUSDM.",
        "unit": "USD/t",
        "frequency": "monthly",
        "since": "2003-01",
        "until": "2026-01",
      ...
      "soybean": {
        "label": "Soja (USD/bushel) [alt]",
        "description": "Preço mensal da soja no CBOT, USD/bushel. Série alternativa à commodity_soybean. Fonte: FRED, PSOYBUSDM.",
        "unit": "USD/bushel",
        "frequency": "monthly",
        "since": "2003-01",
        "until": "2026-01",
      ...
      "steel": {
        "label": "Aço (USD/tonelada) [alt]",
        "description": "Preço mensal do aço (hot-rolled coil), USD/tonelada. Série alternativa à commodity_steel. Fonte: FRED, PSTEELCRHUSDM.",
        "unit": "USD/t",
        "frequency": "monthly",
        "since": "2000-01",
        "until": "2026-01",
      ...
      "sugar": {
        "label": "Açúcar (USD/libra) [alt]",
        "description": "Preço mensal do açúcar bruto (ICE No. 11), USD/libra. Série alternativa à commodity_sugar. Fonte: FRED, PSUGAISAUSDM.",
        "unit": "USD/lb",
        "frequency": "monthly",
        "since": "2011-03",
        "until": "2026-01",
      ...
      "zinc": {
        "label": "Zinco (USD/tonelada) [alt]",
        "description": "Preço mensal do zinco no LME, USD/tonelada. Série alternativa à commodity_zinc. Fonte: FRED, PZINCUSDM.",
        "unit": "USD/t",
        "frequency": "monthly",
        "since": "2003-01",
        "until": "2026-01",
