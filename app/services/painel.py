    ...
    sections = [
        # ── 1. Custo de Vida ─────────────────────────────────────────
        {
            ...
            "kpis": [
                ...
                painel_kpi("electricity_mt",  "Electricidade MT",     "ERSE",      "tariff_mt_peak",        invert_sentiment=True,                                 description=D["electricity_mt"]),
                painel_kpi("electricity_at",  "Electricidade AT",     "ERSE",      "tariff_at_peak",        invert_sentiment=True,                                 description=D["electricity_at"]),
        ...
        # ── 5. Energia ───────────────────────────────────────────────
        {
            ...
            "kpis": [
                ...
                painel_kpi("renewable_share",   "% Energia Renovável",     "DGEG", "renewable_share_electricity", invert_sentiment=False, scale_factor=100, unit_override="%", description=D["renewable_share"]),
                painel_kpi("energy_dependence", "Dependência Energética",  "DGEG", "energy_dependence",           invert_sentiment=True,  scale_factor=100, unit_override="%", description=D["energy_dependence"]),
        ...
        # ── 7. Competitividade ────────────────────────────────────────
        {
            ...
            "kpis": [
                painel_kpi("gdp_per_capita",  "PIB per capita", "EUROSTAT",  "gdp_per_capita_eur", invert_sentiment=False, unit_override="€/hab", description=D["gdp_per_capita"]),
                painel_kpi("rnd_pct_gdp",     "I&D % PIB",      "WORLDBANK", "rnd_pct_gdp",        invert_sentiment=False, unit_override="%",     description=D["rnd_pct_gdp"]),
                painel_kpi("employment_rate", "Taxa de Emprego", "EUROSTAT",  "employment_rate",    invert_sentiment=False, unit_override="%",     description=D["employment_rate"]),
            ],
        },
    ]
